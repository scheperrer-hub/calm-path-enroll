export const de = {
  ...
  registration: {
    ...
    step3: {
      ...
      motherTongueDescription: "Ihre Erstsprache.",
      reportLanguage: "Sprache für den Report",
      reportLanguageDescription: "In welcher Sprache möchten Sie Berichte erhalten?",
      reportLanguagePlaceholder: "Bitte wählen",
    ...
    step4: {
      ...
      retreat: "Retreat",
      retreatDescription: "13 Tage / 12 Nächte, Anreisetag frei wählbar im Zeitraum 19.08. - 03.09.2026",
      ...
      retreatDurationHint: "Voreingestellt sind {{days}} Tage / {{nights}} Nächte – Sie können früher abreisen.",
    ...
    validation: {
      ...
      dateOutOfRange: "Bitte wählen Sie ein Datum zwischen {{from}} und {{to}}",
...
Die Lehrer und der Buddhayana e.V. behalten sich das Recht vor, dem Teilnehmer die Kursteilnahme zu versagen oder früher nach Hause zu schicken, falls er nicht den Regeln oder Instruktionen folgt oder er sich oder andere gefährdet.`,
  ...
  admin: {
    ...
    teacherOverview: {
      ...
      showInactive: "Erledigte und archivierte einblenden",
      inactiveIncluded: "inkl. erledigter und archivierter",
      exportExcel: "Excel",
      exportPdf: "PDF",
      ...
      changeLog: {
        ...
        unavailable: "Änderungsprotokoll ist noch nicht eingerichtet",
        by: "von",
      },
      field: {
        status: "Status",
        assigned_teacher: "Lehrer",
        assigned_teacher_user_id: "Lehrer (Benutzerkonto)",
        ...
        email: "E-Mail",
        phone: "Telefon",
        phone_country: "Ländervorwahl",
        address_street: "Straße",
        address_house_number: "Hausnummer",
        address_zip: "PLZ",
        address_city: "Ort",
        address_country: "Land",
        address_validated: "Adresse geprüft",
        report_language: "Reportsprache",
        course_basic: "Grundkurs gebucht",
        course_retreat: "Retreat gebucht",
        course_few_days: "Tage gebucht",
        start_date_basic: "Start Grundkurs",
        end_date_basic: "Ende Grundkurs",
        start_date_retreat: "Start Retreat",
        end_date_retreat: "Ende Retreat",
        start_date_few: "Start Tage",
        end_date_few: "Ende Tage",
        has_basic_course: "Basiskurs besucht",
        basic_course_days: "Basiskurs-Tage",
        vip_basic_when: "Basiskurs wann",
        vip_basic_where: "Basiskurs wo",
        vip_basic_teacher: "Basiskurs Lehrer",
        vip_other_experience: "Weitere Erfahrung",
        mother_tongue: "Muttersprache",
        second_language: "Zweitsprache",
        impairments: "Beeinträchtigungen",
        additional_info: "Zusätzliche Informationen",
        consent_privacy: "Datenschutz zugestimmt",
        registration_date: "Anmeldedatum",
      },
      exportTitle: "Schüler-Übersicht nach Lehrer",
      generatedOn: "Stand",
      page: "Seite",
      sheetName: "Lehrer-Übersicht",
      fileBaseName: "lehrer-uebersicht",
      course: {
        basic: "Grundkurs",
        retreat: "Retreat",
        few: "Tage",
